        ...
        public Mono<UploadResponse> uploadVideo(String videoId, String appId, FilePart filePart) {
                ...
                return validateFile(filePart)
                                .flatMap(valid -> {
                                        ...
                                        Sinks.Many<UploadProgressEvent> progressSink = Sinks.many().multicast()
                                        ...
                                        return storageService.uploadFile(videoId, appId, filePart, progressSink)
                                                        .flatMap(objectKey -> {
                                                                String storageBasePath = storageService
                                                                                .getStorageBasePath(appId, videoId);
                                                                ...
                                                                UpdateAfterUploadRequest catalogUpdate = UpdateAfterUploadRequest
                                                                                ...
                                                                                .sourceFileSizeBytes(0L) // Will be
                                                                                                         // updated from
                                                                                                         // actual file
                                                                                                         // size
                                                                                .sourceContentType(filePart.headers()
                                                                                                .getContentType() != null
                                                                                                                ? filePart.headers()
                                                                                                                                .getContentType()
                                                                                                                                .toString()
                                                        ...
                                                        .flatMap(transcodeMessage -> messagePublisher
                                                                        .publishTranscodeMessage(transcodeMessage)
                                                        ...
                                                        .map(transcodeMessage -> UploadResponse.builder()
                                                                        ...
                                                                        .fileSize(0L)
                                                                        .storageBasePath(transcodeMessage
                                                                                        .getStorageBasePath())
                                                                        .status("PROCESSING")
                                                                        .build())
                                                        .doOnSuccess(response -> log.info(
                                                                        ...
                                                                        videoId))
                                                        .doOnError(error -> {
                                                                log.error("Upload failed for videoId: {}", videoId,
                                                                                error);
                                                                // Emit failure event
